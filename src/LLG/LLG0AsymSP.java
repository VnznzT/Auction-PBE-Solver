...
public class LLG0AsymSP implements AuctionRound<Double,Double> {
    PBEContext context;
    int subgame;
    public LLG0AsymSP(PBEContext context, int subgame) {
            ...
            if (i==0){
                ...
                if(context.isVerification()) {
                    ...
                    expectedUtilities = context.getCache().getUtilities(reference.index, reference.subgame);
                                ...
                                reward = expectedUtilities.get(reference.player).getUtility(v)-secondBid;
