...
public class SubGameTransitionLLGAsymFP extends SubGameTransition<Double,Double>{

    public SubGameTransitionLLGAsymFP() {
        super();
    }
    ...
    public Reference transition(int subgame, int i, List<Strategy<Double, Double>> currentStrategies, Belief<Double> beliefDistribution, Double[] bids, int winner) {
        ...
        belief[0] = values[hi-1];         belief[1] = values[hi];
